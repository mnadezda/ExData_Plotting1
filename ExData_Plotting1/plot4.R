...
par(mfrow=c(2,2))
plot(EPC_Data$DT, EPC_Data$Global_active_power, type = 'l', ylab='Global Active Power', xlab = NA)
plot(EPC_Data$DT, EPC_Data$Voltage, type = 'l', ylab='Global Active Power', xlab = 'datetime')
...
plot(EPC_Data$DT, EPC_Data$Global_reactive_power, type = 'l', ylab='Global Active Power', xlab = 'datetime')
dev.off()